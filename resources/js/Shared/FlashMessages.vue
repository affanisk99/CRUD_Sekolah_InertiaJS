<template>
  <div>
    <div v-if="$page.flash.success && show" class="flex items-center justify-between max-w-3xl mb-8 bg-green-500 rounded">
      <div class="flex items-center">
        ...
        <div class="py-4 text-sm font-medium text-white">{{ $page.flash.success }}</div>
      </div>
    ...
    <div v-if="($page.flash.error || Object.keys($page.errors).length > 0) && show" class="flex items-center justify-between max-w-3xl mb-8 bg-red-500 rounded">
      <div class="flex items-center">
